  ...
  work: [
    {
      ...
      descriptions: [
        "⦿ Spearheaded the development and training of NLP models for proof-of-concept projects on text classification, utilizing both publicly available datasets and custom data collection through web scraping techniques.",
        ...
        "⦿ Led the implementation and experimentation of new product features, incorporating advanced NLP methodologies such as fine-tuning of large language models (LLMs), and developing sophisticated systems through function calling and retrieval-augmented generation techniques.",
    ...
    },
    {
      ...
      descriptions: [
        "⦿ Co-led the full-stack development of a cutting-edge visualization system tailored for epigenetics researchers, facilitating the exploration of connections between DNA methylation patterns and complex human traits using advanced network summarization and community detection algorithms.",
    ...
    },
    {
      ...
      descriptions: [
        "⦿ Architected and implemented the full-stack development of a sophisticated multidimensional time-series search, visualization, and prediction system, empowering health experts and decision-makers to dissect and compare global pandemic trends. Incorporated advanced time-series similarity and clustering algorithms, complemented by uncertainty visualization, to deliver critical insights.",
        "⦿ Partnered with a diverse team of 30 academics from data science and data visualization fields to forge interactive Observable notebooks. These resources elucidate state-of-the-art data-mining techniques and innovative dashboard designs tailored for enhancing governmental decision-making capabilities.",
